...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// 
			this->callLibraryToolStripMenuItem->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(3) {
...
#pragma region Self produced code
	...
	private: System::Void callLibrary()
	{
		...
		if (hMod_L != NULL)
		{
			...
			fteo::api::TMyPoint* testPoint = func21(65535, "Ìîÿ òî÷êà â dll. Name & id send for library");
