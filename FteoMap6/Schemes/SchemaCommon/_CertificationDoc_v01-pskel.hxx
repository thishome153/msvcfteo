...
#ifndef CXX__SCHEMES_SCHEMA_COMMON__CERTIFICATION_DOC_V01_PSKEL_HXX
#define CXX__SCHEMES_SCHEMA_COMMON__CERTIFICATION_DOC_V01_PSKEL_HXX
...
namespace Cer1
{
  class tCertificationDoc_pskel;
  class Official_pskel;
}
...
namespace Cer1
{
  class tCertificationDoc_pskel: public ::xml_schema::complex_content
  {
    public:
    ...
    //
    void
    Organization_parser (::Simple1::s500_pskel&);

    void
    Date_parser (::xml_schema::date_pskel&);

    void
    Number_parser (::Simple1::s100_pskel&);

    void
    Official_parser (::Cer1::Official_pskel&);
    ...
    protected:
    ::Simple1::s500_pskel* Organization_parser_;
    ::xml_schema::date_pskel* Date_parser_;
    ::Simple1::s100_pskel* Number_parser_;
    ::Cer1::Official_pskel* Official_parser_;
  };

  class Official_pskel: public ::xml_schema::complex_content
  {
    public:
    // Parser callbacks. Override them in your implementation.
    //
    ...
    //
    void
    Appointment_parser (::Simple1::s1_255_pskel&);

    void
    FamilyName_parser (::KVZU::SMEV::rus_100_pskel&);

    void
    FirstName_parser (::KVZU::SMEV::rus_100_pskel&);

    void
    Patronymic_parser (::KVZU::SMEV::rus_100_pskel&);
    ...
    protected:
    ::Simple1::s1_255_pskel* Appointment_parser_;
    ::KVZU::SMEV::rus_100_pskel* FamilyName_parser_;
    ::KVZU::SMEV::rus_100_pskel* FirstName_parser_;
    ::KVZU::SMEV::rus_100_pskel* Patronymic_parser_;
  };
}
...
#endif // CXX__SCHEMES_SCHEMA_COMMON__CERTIFICATION_DOC_V01_PSKEL_HXX
